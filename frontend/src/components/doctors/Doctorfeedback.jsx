          ...
          <div className='flex justify-between gap-10 mb-[30px]'>
             <div className='flex gap-3'>
              ...
              <div>
                ...
                <p className='text-[14px] leading-6 text-textColor '>{FormatDate('02-07-2023')}</p>
                <p className='text__para mt-3 font-medium text-[15px]'>good treatment,highly recommended</p>
              </div>
