            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  Nesciunt, aspernatur! Veniam itaque ipsam sequi sit. Minus
                  voluptatum natus eius, voluptatibus nobis iste aliquam
                  veritatis illum alias nemo, ducimus aut ipsa mollitia ratione.
                  Ratione, tenetur.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5">
              ...
              <p className="text-[16px] leading-7 text-textColor font-[700] text-center ">
                World class care for everyone.our health system offers
                unmatched,expert healthcare.From the lab to clinic.
              </p>
              <Link
                to="/doctors"
      ...
      <section>
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-6">
              ...
              <div className="w-[150px] lg:w-[248px]  bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                  ...
                  <h2 className="text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700]">
                    Wayne Collins
                  </h2>
                </div>
              </div>
