...
import SlidePanel from '../components/doctors/SlidePanel'
      ...
      <div className='grid md:grid-cols-3 gap-[50px]'>
        <div className='md:col-span-2'>
          <div className='flex items-center flex-col md:flex-row gap-5'>
            ...
            <div>
              <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded text-center'>Surgeon</span>
              ...
              <p className='text__para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px] '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio porro omnis reprehenderit? A nesciunt veritatis veniam culpa dicta! Reprehenderit earum, provident placeat voluptas dicta iusto libero eaque cum tenetur sed.</p>
            </div>
          </div>
